...
export const resultVariableDescriptions: Record<string, VariableDescription> = {
  ...
  ZEst: localize(
    ...
    [
      ...
      'Caution: ZEst is undefined when Zf=1 and is displayed as unavailable (-). Very short protocols reduce stability.',
    ].join('\n')
  ),
  Zd: localize(
    'Zd',
  ...
  EBPer: localize(
    ...
    [
      ...
      'Operational basis: Available only when EA>=4 and Lambda<1.0. It requires |M-WSumC|>=2.0 when EA is 4-10, or >=2.5 when EA is greater than 10; the larger side is then divided by the smaller side.',
      ...
      'Caution: EBPer is unavailable when either EB side is zero. One-sided style can be adaptive in context.',
    ].join('\n')
  ),
  eb: localize(
    'eb',
  ...
  D: localize(
    ...
    [
      ...
      'Operational basis: EA-es is converted to scaled D: -2.5 through +2.5 becomes 0, then each additional 2.5 points changes D by one unit with the same sign.',
  ...
  AdjD: localize(
    ...
    [
      ...
      'Operational basis: EA-AdjEs is converted with the same 2.5-point scaled D rule.',
  ...
  M_minus: localize(
    'M-',
    [
      'Definition: Count of human movement responses with minus form quality.',
      'Operational basis: Frequency of responses containing an M determinant and FQ-.',
  ...
  Mnone: localize(
    'Mnone',
    [
      'Definition: Count of human movement responses coded with no form quality.',
      'Operational basis: Frequency of responses containing an M determinant and FQ none; FQu and FQ- are not included.',
      ...
      'Caution: This is a frequency, not a proportion. Verify that FQ was genuinely unassignable.',
    ].join('\n')
  ),
  ...
  FC_CF_C: localize(
    ...
    [
      ...
      'Operational basis: The conventional label remains FC:CF+C, while the displayed right side is calculated as CF+C+Cn. WSumC and S-CON criterion 7 retain their separate formulas and exclude Cn.',
  ...
  SumC_WSumC: localize(
    ...
    [
      ...
      "Operational basis: The two raw values are displayed as SumC':WSumC; they are not divided or reduced to a quotient.",
  ...
  Afr: localize(
    ...
    [
      ...
      'Operational basis: Responses on the last three cards divided by responses on the first seven cards.',
      ...
      'Caution: If the first seven cards contain no responses, Afr is undefined and displayed as unavailable (-).',
    ].join('\n')
  ),
  S_aff: localize(
    'S',
  ...
  Blends_R: localize(
    'Blends:R',
    [
      'Definition: Relationship between blended-determinant response count and total responses.',
      'Operational basis: The two raw counts are displayed as Blends:R; they are not divided or reduced to a quotient.',
  ...
  WDA_percent: localize(
    ...
    [
      ...
      'Operational basis: Acceptable FQ among responses in the W/D location group.',
      ...
      'Caution: If there are no W/D responses, WDA% is undefined and displayed as unavailable (-).',
    ].join('\n')
  ),
  ...
  _3r_2_R: localize(
    ...
    [
      ...
      'Operational basis: [3 x (Fr+rF) + Sum(2)] / R; each reflection is weighted as three pair responses.',
  ...
  PTI: localize(
    ...
    [
      ...
      '[Evidence Strength] supported. Empirical support is relatively strong among the special indices, but the score cannot independently diagnose a thought disorder or psychotic disorder.',
  ...
  DEPI: localize(
    'DEPI',
    [
      'Definition: DEPI (Depression Index) is an operational composite proposed to screen for depression-related patterns.',
      ...
      '[Evidence Strength] limited. Empirical associations with depression-related constructs are modest, so a positive result calls for further assessment rather than symptom or diagnostic inference.',
      'Interpretive direction: Treat a positive result as a prompt to assess current symptoms, duration, and impairment; do not use a negative result to rule out depression.',
  ...
  CDI: localize(
    'CDI',
    [
      'Definition: CDI (Coping Deficit Index) is an operational composite proposed to screen coping and interpersonal vulnerability.',
      ...
      '[Evidence Strength] limited. Empirical associations are modest and do not establish helplessness, immaturity, dependency, or a fixed trait.',
      'Interpretive direction: Use a positive result only as a provisional prompt to review current stress, observed coping, support, and developmental-cultural context.',
  ...
  SCON: localize(
    ...
    [
      ...
      '[Evidence Strength] supported-high-stakes. Association with suicide-related risk is relatively strong, but low base rates permit false positives and a negative result cannot rule out risk.',
      'Interpretive direction: Any result must be followed by direct assessment when risk is clinically relevant.',
      'Cross-checks: Directly assess current ideation, intent, plan, access to means, prior attempts, recent changes, and protective factors.',
      'Common misreading: S-CON is not a deterministic prediction tool and must never replace immediate safety action.',
  ...
  HVI: localize(
    'HVI',
    [
      'Definition: HVI (Hypervigilance Index) is an operational variable combination proposed to represent guarded or threat-monitoring style.',
      'Operational basis: Derived from a required gate condition plus additional criteria count in this app configuration.',
      '[Evidence Strength] weak-inconsistent. Empirical support for inferring hypervigilance or distrust is weak and inconsistent.',
      'Interpretive direction: Keep a positive result as a low-confidence organizing hypothesis only.',
      'Cross-checks: Require independent evidence from actual danger, trauma history, cultural guardedness, interview data, and observed vigilance.',
      'Common misreading: A positive result does not establish paranoia, mistrust, or a stable personality trait.',
      'Caution: Do not elevate HVI beyond low confidence without convergent evidence.',
    ].join('\n')
  ),
  OBS: localize(
    'OBS',
    [
      'Definition: OBS (Obsessive Style Index) is an operational rule combination proposed to represent precision and control-related style.',
      ...
      '[Evidence Strength] insufficient. Construct-validity evidence is insufficient for inferring obsessive personality features or impairment.',
      'Interpretive direction: Treat a positive result only as confirmation that the operational variable combination was met.',
      'Cross-checks: Verify perfectionism, compulsivity, rigidity, distress, and impairment independently in interview and behavior.',
      'Common misreading: OBS positivity does not establish obsessive style, OCD, personality pathology, or impairment.',
      'Caution: Do not convert the score into a trait claim without independent evidence.',
    ].join('\n')
  ),
};
...
const KO_DESCRIPTION_OVERRIDES: Partial<Record<string, string>> = {
  ...
  ZEst: [
    ...
    'Caution: Zf=1에서는 ZEst가 정의되지 않아 산출 불가(-)로 표시됩니다. 짧은 프로토콜은 해석 안정성이 낮습니다.',
  ].join('\n'),
  Zd: [
  ...
  EBPer: [
    ...
    'Operational basis: EA>=4이고 Lambda<1.0일 때만 산출합니다. EA가 4-10이면 |M-WSumC|>=2.0, EA가 10보다 크면 |M-WSumC|>=2.5여야 하며, 이후 큰 쪽을 작은 쪽으로 나눕니다.',
    'Interpretive direction: 높을수록 한 가지 처리 스타일 의존이 강할 수 있습니다.',
    'Cross-checks: Lambda, Afr, 조정 지표와 함께 확인합니다.',
    'Caution: EB 어느 한쪽이 0이면 산출 불가입니다. 한쪽성은 맥락에 따라 적응적일 수도 있습니다.',
  ].join('\n'),
  eb: [
  ...
  D: [
    ...
    'Operational basis: EA-es가 -2.5부터 +2.5이면 0이며, 이후 2.5점마다 같은 부호로 D가 1단계씩 변환됩니다.',
  ...
  AdjD: [
    ...
    'Operational basis: EA-AdjEs를 D와 같은 2.5점 단위 척도 규칙으로 변환합니다.',
  ...
  M_minus: [
    ...
    'Operational basis: M 결정인과 FQ-가 함께 있는 반응 수를 집계합니다.',
  ...
  Mnone: [
    'Definition: 형태질을 부여할 수 없는 인간운동(Mnone) 빈도입니다.',
    'Operational basis: M 결정인과 FQ none이 함께 있는 반응만 집계하며 FQu와 FQ-는 포함하지 않습니다.',
    'Interpretive direction: 높을수록 행위 표상의 형태 고정성이 약할 수 있습니다.',
    'Cross-checks: M-, WDA%, 인지 특수점수와 함께 해석합니다.',
    'Caution: 비율이 아니라 빈도입니다. 형태질을 실제로 부여할 수 없는 반응인지 확인합니다.',
  ].join('\n'),
  FC_CF_C: [
    'Definition: 색채 조절 비율(FC:CF+C)입니다.',
    'Operational basis: 관례적 이름은 FC:CF+C이지만 화면의 오른쪽 값은 CF+C+Cn으로 계산합니다. WSumC와 S-CON 7번 기준은 별도 식을 사용하며 Cn을 제외합니다.',
  ...
  SumC_WSumC: [
    ...
    'Operational basis: 두 원값을 SumC\':WSumC로 나란히 표시하며, 서로 나누거나 몫으로 약분하지 않습니다.',
  ...
  Afr: [
    ...
    'Caution: 1-7번 카드 반응이 0개이면 Afr는 정의되지 않아 산출 불가(-)로 표시됩니다.',
  ].join('\n'),
  S_aff: [
  ...
  Blends_R: [
    'Definition: 블렌드 반응 수와 전체 반응 수의 관계(Blends:R)입니다.',
    'Operational basis: 두 원빈도를 Blends:R로 나란히 표시하며, 서로 나누거나 몫으로 약분하지 않습니다.',
  ...
  WDA_percent: [
    ...
    'Caution: W/D 반응이 하나도 없으면 WDA%는 정의되지 않아 산출 불가(-)로 표시됩니다.',
  ].join('\n'),
  X_minus_percent: [
  ...
  _3r_2_R: [
    ...
    'Operational basis: [3 x (Fr+rF) + Sum(2)] / R이며, 반사반응 1개를 쌍반응 3개와 같은 가중치로 계산합니다.',
  ...
  PTI: [
    ...
    '[Evidence Strength] supported. 특수지표 가운데 경험적 지지는 비교적 강하지만, 사고장애나 정신병적 장애를 단독 진단할 수 없습니다.',
  ...
  DEPI: [
    'Definition: DEPI(우울 지표)는 우울 관련 패턴을 선별하기 위해 제안된 조작적 복합지표입니다.',
    'Operational basis: 정서 수축/고통, 자기평가 부담 등 다중 기준을 앱 규칙으로 산출합니다.',
    '[Evidence Strength] limited. 우울 관련 구성개념과의 경험적 관련성은 제한적이므로, 양성 결과만으로 특정 증상이나 진단을 추론하지 않습니다.',
    'Interpretive direction: 양성은 현재 증상·기간·기능손상을 추가 평가하라는 신호이며, 음성도 우울을 배제하지 못합니다.',
    'Cross-checks: SumV, MOR, Afr, FD, 면담 맥락과 함께 해석합니다.',
    'Caution: 단일 시점 점수로 주요우울 삽화를 확정하지 않습니다.',
  ].join('\n'),
  CDI: [
    'Definition: CDI(대처 결핍 지표)는 대처와 대인 취약성을 선별하기 위해 제안된 조작적 복합지표입니다.',
    'Operational basis: 자원 수준, 상호성 지표, 정서 조절 부담 기준을 결합해 계산합니다.',
    '[Evidence Strength] limited. 경험적 관련성은 제한적이며 무기력, 미성숙, 의존성 또는 고정 특성을 확정하지 않습니다.',
    'Interpretive direction: 양성은 현재 스트레스, 실제 대처행동, 지지체계, 발달·문화 맥락을 추가 검토하는 잠정 신호로만 사용합니다.',
  ...
  SCON: [
    ...
    '[Evidence Strength] supported-high-stakes. 자살 관련 위험과의 관련성은 비교적 강하지만, 낮은 기저율 때문에 거짓양성이 가능하고 음성도 위험을 배제하지 못합니다.',
    'Interpretive direction: 점수와 관계없이 임상적으로 위험이 의심되면 직접 위험평가를 실시합니다.',
    'Cross-checks: 현재 자살사고, 의도, 계획, 수단 접근성, 과거 시도, 최근 변화, 보호요인을 직접 확인합니다.',
    'Caution: 예측 도구나 단독 의사결정 종결점으로 사용하지 말고 필요한 안전조치를 우선합니다.',
  ].join('\n'),
  HVI: [
    'Definition: HVI는 경계 또는 위협감시 스타일을 나타낸다고 제안된 조작적 변수 조합입니다.',
    'Operational basis: 필수 게이트 조건 + 추가 기준 충족 수로 앱에서 산출합니다.',
    '[Evidence Strength] weak-inconsistent. 과경계나 불신을 추론하는 경험적 지지는 약하고 일관되지 않습니다.',
    'Interpretive direction: 양성은 낮은 신뢰도의 조직 가설로만 유지합니다.',
    'Cross-checks: 실제 위험환경, 외상력, 문화적 경계성, 면담자료, 독립적으로 관찰된 경계행동을 확인합니다.',
    'Caution: 수렴 근거 없이 불신·편집성·고정 성격특성으로 확대하지 않습니다.',
  ].join('\n'),
  OBS: [
    'Definition: OBS는 정밀성과 통제 관련 스타일을 나타낸다고 제안된 조작적 규칙 조합입니다.',
    'Operational basis: 형태/조직/통제 관련 규칙 조합으로 앱에서 결정합니다.',
    '[Evidence Strength] insufficient. 강박적 성격특성이나 기능손상을 추론할 구성타당도 근거가 충분하지 않습니다.',
    'Interpretive direction: 양성은 해당 변수 조합이 충족되었다는 조작적 사실로만 취급합니다.',
    'Cross-checks: 완벽주의, 강박성, 경직성, 고통과 기능손상을 면담과 행동에서 독립적으로 확인합니다.',
    'Caution: OBS 양성을 강박적 특성, OCD, 성격병리 또는 손상으로 변환하지 않습니다.',
  ].join('\n'),
};
...
const ES_DESCRIPTION_OVERRIDES: Partial<Record<string, string>> = {
  ...
  ZEst: ['Definition: ZSum esperado segun tamano del protocolo.', 'Operational basis: Consulta de tabla ZEST por Zf.', 'Interpretive direction: Linea base para interpretar Zd.', 'Cross-checks: Usar junto con ZSum observado y Zd.', 'Caution: Con Zf=1, ZEst no esta definido y se muestra como no disponible (-).'].join('\n'),
  ...
  D: ['Definition: Indice de tolerancia actual al estres.', 'Operational basis: EA-es entre -2.5 y +2.5 produce 0; despues D cambia una unidad por cada 2.5 puntos adicionales, conservando el signo.', 'Interpretive direction: Negativo sugiere demanda mayor que recursos actuales.', 'Cross-checks: Integrar con AdjD y AdjEs.', 'Caution: Sensible a estado situacional.'].join('\n'),
  AdjD: ['Definition: Tolerancia al estres ajustada.', 'Operational basis: EA-AdjEs se convierte con la misma regla D escalada de 2.5 puntos.', 'Interpretive direction: Ayuda a separar presion situacional transitoria.', 'Cross-checks: Comparar brecha D vs AdjD.', 'Caution: Revisar supuestos del ajuste.'].join('\n'),
  PTI: [
    'Definition: PTI es un índice compuesto de cribado para patrones de desorganización perceptiva y del pensamiento.',
    'Operational basis: Criterios múltiples de forma, puntuaciones cognitivas graves, M- y umbrales de la app.',
    '[Evidence Strength] supported. El respaldo empírico es relativamente fuerte entre los índices especiales, pero no permite diagnosticar por sí solo un trastorno del pensamiento o psicótico.',
    'Interpretive direction: Más criterios positivos aumentan la preocupación y requieren revisar el patrón real, no solo la etiqueta.',
    'Cross-checks: XA%, WDA%, X-%, WSum6, M- y calidad del protocolo.',
    'Caution: Usar como señal estructurada dentro de una integración clínica completa.',
  ].join('\n'),
  DEPI: [
    'Definition: DEPI es un compuesto operativo propuesto para cribar patrones relacionados con depresión.',
    'Operational basis: Criterios combinados de constricción afectiva, malestar y carga de autoevaluación.',
    '[Evidence Strength] limited. Las asociaciones empíricas son modestas; un resultado positivo pide evaluación adicional y no prueba síntomas concretos ni un diagnóstico.',
    'Interpretive direction: Evaluar síntomas actuales, duración y deterioro; un resultado negativo no excluye depresión.',
    'Cross-checks: SumV, MOR, Afr, FD y entrevista clínica.',
    'Caution: No convertir la puntuación en un episodio depresivo ni usarla para descartarlo.',
  ].join('\n'),
  CDI: [
    'Definition: CDI es un compuesto operativo propuesto para cribar vulnerabilidad de afrontamiento e interpersonal.',
    'Operational basis: Criterios de recursos, reciprocidad interpersonal y carga regulatoria.',
    '[Evidence Strength] limited. Las asociaciones empíricas son modestas y no establecen indefensión, inmadurez, dependencia ni un rasgo fijo.',
    'Interpretive direction: Usar el resultado solo para revisar estrés actual, conducta de afrontamiento, apoyo y contexto evolutivo-cultural.',
    'Cross-checks: EA, AdjD, COP/AG, SumT, Food e índice de aislamiento.',
    'Caution: Mantener la inferencia provisional y contextual.',
  ].join('\n'),
  SCON: [
    'Definition: S-CON es una constelación de cribado de señales relacionadas con riesgo suicida.',
    'Operational basis: Configuración multicriterio de carga disfórica, mediación y marcadores relacionados.',
    '[Evidence Strength] supported-high-stakes. La asociación con riesgo suicida es relativamente fuerte, pero la baja tasa base permite falsos positivos y un resultado negativo no descarta riesgo.',
    'Interpretive direction: Evaluar directamente el riesgo cuando sea clínicamente relevante, con independencia de la puntuación.',
    'Cross-checks: Ideación, intención, plan, acceso a medios, intentos previos, cambios recientes y factores protectores.',
    'Caution: No usar como predicción determinista ni retrasar medidas de seguridad necesarias.',
  ].join('\n'),
  HVI: [
    'Definition: HVI es una combinación operativa propuesta para representar vigilancia defensiva o control de amenazas.',
    'Operational basis: Condición de puerta requerida más recuento de criterios adicionales.',
    '[Evidence Strength] weak-inconsistent. El respaldo empírico para inferir hipervigilancia o desconfianza es débil e inconsistente.',
    'Interpretive direction: Mantener un resultado positivo solo como hipótesis organizadora de baja confianza.',
    'Cross-checks: Peligro real, historia de trauma, cautela cultural, entrevista y vigilancia observada de forma independiente.',
    'Caution: No inferir paranoia, desconfianza ni rasgo estable sin evidencia convergente.',
  ].join('\n'),
  OBS: [
    'Definition: OBS es una combinación operativa de reglas propuesta para un estilo relacionado con precisión y control.',
    'Operational basis: Reglas sobre forma, organización y control.',
    '[Evidence Strength] insufficient. La evidencia de validez de constructo es insuficiente para inferir rasgos obsesivos o deterioro.',
    'Interpretive direction: Tratar un resultado positivo solo como confirmación de que se cumplió la combinación operativa.',
    'Cross-checks: Verificar perfeccionismo, compulsividad, rigidez, malestar y deterioro mediante entrevista y conducta.',
    'Caution: No convertir OBS en estilo obsesivo, TOC, patología de personalidad ni deterioro.',
  ].join('\n'),
  ...
  EBPer: ['Definition: Indicador de unilateralidad del balance experiencial.', 'Operational basis: Solo se calcula con EA>=4 y Lambda<1.0; exige |M-WSumC|>=2.0 si EA es 4-10 o >=2.5 si EA>10, y luego divide el lado mayor por el menor.', 'Interpretive direction: Mayor unilateralidad sugiere dependencia rigida de un estilo.', 'Cross-checks: Integrar con Lambda, Afr y D/AdjD.', 'Caution: No esta disponible si uno de los lados de EB es cero.'].join('\n'),
  ...
  M_minus: ['Definition: Frecuencia de movimiento humano con mala calidad formal (M-).', 'Operational basis: Conteo de respuestas que contienen determinante M y FQ-.', 'Interpretive direction: Elevacion sugiere mayor distorsion en elaboracion ideacional.', 'Cross-checks: Revisar con XA%, WDA%, WSum6 y PTI.', 'Caution: Es una frecuencia, no una proporcion.'].join('\n'),
  ...
  Mnone: ['Definition: Frecuencia de movimiento humano sin calidad formal asignable.', 'Operational basis: Conteo de respuestas con determinante M y FQ none; no incluye FQu ni FQ-.', 'Interpretive direction: Elevacion sugiere anclaje formal menos estable.', 'Cross-checks: Revisar con M-, WDA% y WSum6.', 'Caution: Es una frecuencia, no una proporcion.'].join('\n'),
  FC_CF_C: ['Definition: Razon de modulacion de color FC frente a CF+C.', 'Operational basis: La etiqueta convencional se mantiene, pero el lado derecho mostrado es CF+C+Cn. WSumC y el criterio 7 de S-CON conservan formulas separadas y excluyen Cn.', 'Interpretive direction: FC dominante sugiere mayor modulacion; CF/C dominante menor control.', 'Cross-checks: Integrar con Pure C, Afr y D/AdjD.', 'Caution: Interpretar con base total de respuestas de color.'].join('\n'),
  ...
  SumC_WSumC: ['Definition: Relacion de SumC\' respecto a WSumC.', "Operational basis: Los dos valores brutos se muestran como SumC':WSumC; no se dividen ni se reducen a un cociente.", 'Interpretive direction: Dominio acromatico relativo sugiere mayor tono disforico.', 'Cross-checks: Integrar con SumV/SumY, DEPI y FC:CF+C.', 'Caution: Revisar siempre ambos componentes por separado.'].join('\n'),
  Afr: ['Definition: Razon afectiva de aproximacion a estimulos cromaticos.', 'Operational basis: Respuestas de las ultimas 3 laminas divididas por las primeras 7.', 'Interpretive direction: Afr bajo sugiere constriccion/evitacion; Afr alto mayor acercamiento afectivo.', 'Cross-checks: Integrar con FC:CF+C, Pure C y EB/EBPer.', 'Caution: Sin respuestas en las primeras 7 laminas, Afr no esta definido y se muestra como no disponible (-).'].join('\n'),
  ...
  Blends_R: ['Definition: Relacion entre respuestas blend y R.', 'Operational basis: Los dos conteos brutos se muestran como Blends:R; no se dividen ni se reducen a un cociente.', 'Interpretive direction: Elevacion sugiere mayor complejidad de procesamiento.', 'Cross-checks: Integrar con DQ, WSum6 y mediacion.', 'Caution: Complejidad no implica adaptacion automaticamente.'].join('\n'),
  ...
  _3r_2_R: ['Definition: Indice de egocentricidad (3r+(2)/R).', 'Operational basis: [3 x (Fr+rF) + Sum(2)] / R; cada reflejo pesa como tres respuestas de par.', 'Interpretive direction: Muy bajo sugiere menor foco en si; muy alto mayor foco en si.', 'Cross-checks: Integrar con Fr+rF, H ratio e interpersonal.', 'Caution: Evitar etiquetas de rasgo con este indice aislado.'].join('\n'),
...
const PT_DESCRIPTION_OVERRIDES: Partial<Record<string, string>> = {
  ...
  ZEst: ['Definition: ZSum esperado conforme tamanho do protocolo.', 'Operational basis: Consulta da tabela ZEST por Zf.', 'Interpretive direction: Linha de base para interpretar Zd.', 'Cross-checks: Usar junto com ZSum observado e Zd.', 'Caution: Com Zf=1, ZEst nao e definido e aparece como indisponivel (-).'].join('\n'),
  ...
  D: ['Definition: Indice de tolerancia atual ao estresse.', 'Operational basis: EA-es entre -2.5 e +2.5 produz 0; depois D muda uma unidade a cada 2.5 pontos adicionais, preservando o sinal.', 'Interpretive direction: Negativo sugere demanda maior que recursos atuais.', 'Cross-checks: Integrar com AdjD e AdjEs.', 'Caution: Sensivel a estado situacional.'].join('\n'),
  AdjD: ['Definition: Tolerancia ao estresse ajustada.', 'Operational basis: EA-AdjEs e convertido pela mesma regra D escalonada de 2.5 pontos.', 'Interpretive direction: Ajuda a separar pressao situacional transitoria.', 'Cross-checks: Comparar diferenca D vs AdjD.', 'Caution: Revisar pressupostos do ajuste.'].join('\n'),
  PTI: [
    'Definition: PTI é um índice composto de triagem para padrões de desorganização perceptiva e do pensamento.',
    'Operational basis: Critérios múltiplos de forma, escores cognitivos graves, M- e limiares do app.',
    '[Evidence Strength] supported. O respaldo empírico é relativamente forte entre os índices especiais, mas não permite diagnosticar isoladamente transtorno do pensamento ou psicótico.',
    'Interpretive direction: Mais critérios positivos aumentam a preocupação e exigem revisão do padrão real, não apenas do rótulo.',
    'Cross-checks: XA%, WDA%, X-%, WSum6, M- e qualidade do protocolo.',
    'Caution: Usar como sinal estruturado dentro de integração clínica completa.',
  ].join('\n'),
  DEPI: [
    'Definition: DEPI é um composto operacional proposto para triagem de padrões relacionados à depressão.',
    'Operational basis: Critérios combinados de constrição afetiva, sofrimento e carga de autoavaliação.',
    '[Evidence Strength] limited. As associações empíricas são modestas; resultado positivo pede avaliação adicional e não comprova sintomas específicos nem diagnóstico.',
    'Interpretive direction: Avaliar sintomas atuais, duração e prejuízo; resultado negativo não exclui depressão.',
    'Cross-checks: SumV, MOR, Afr, FD e entrevista clínica.',
    'Caution: Não converter a pontuação em episódio depressivo nem usá-la para descartá-lo.',
  ].join('\n'),
  CDI: [
    'Definition: CDI é um composto operacional proposto para triagem de vulnerabilidade de coping e interpessoal.',
    'Operational basis: Critérios de recursos, reciprocidade interpessoal e carga regulatória.',
    '[Evidence Strength] limited. As associações empíricas são modestas e não estabelecem desamparo, imaturidade, dependência ou traço fixo.',
    'Interpretive direction: Usar o resultado apenas para revisar estresse atual, comportamento de coping, apoio e contexto desenvolvimental-cultural.',
    'Cross-checks: EA, AdjD, COP/AG, SumT, Food e índice de isolamento.',
    'Caution: Manter a inferência provisória e contextual.',
  ].join('\n'),
  SCON: [
    'Definition: S-CON é uma constelação de triagem de sinais relacionados ao risco suicida.',
    'Operational basis: Configuração multicritério de carga disfórica, mediação e marcadores relacionados.',
    '[Evidence Strength] supported-high-stakes. A associação com risco suicida é relativamente forte, mas a baixa taxa-base permite falsos positivos e resultado negativo não exclui risco.',
    'Interpretive direction: Avaliar diretamente o risco quando clinicamente relevante, independentemente da pontuação.',
    'Cross-checks: Ideação, intenção, plano, acesso a meios, tentativas prévias, mudanças recentes e fatores protetores.',
    'Caution: Não usar como previsão determinística nem atrasar medidas de segurança necessárias.',
  ].join('\n'),
  HVI: [
    'Definition: HVI é uma combinação operacional proposta para representar vigilância defensiva ou monitoramento de ameaça.',
    'Operational basis: Condição de gate obrigatória mais contagem de critérios adicionais.',
    '[Evidence Strength] weak-inconsistent. O respaldo empírico para inferir hipervigilância ou desconfiança é fraco e inconsistente.',
    'Interpretive direction: Manter resultado positivo apenas como hipótese organizadora de baixa confiança.',
    'Cross-checks: Perigo real, história de trauma, cautela cultural, entrevista e vigilância observada de forma independente.',
    'Caution: Não inferir paranoia, desconfiança ou traço estável sem evidência convergente.',
  ].join('\n'),
  OBS: [
    'Definition: OBS é uma combinação operacional de regras proposta para estilo relacionado à precisão e ao controle.',
    'Operational basis: Regras sobre forma, organização e controle.',
    '[Evidence Strength] insufficient. A evidência de validade de construto é insuficiente para inferir traços obsessivos ou prejuízo.',
    'Interpretive direction: Tratar resultado positivo apenas como confirmação de que a combinação operacional foi satisfeita.',
    'Cross-checks: Confirmar perfeccionismo, compulsividade, rigidez, sofrimento e prejuízo por entrevista e comportamento.',
    'Caution: Não converter OBS em estilo obsessivo, TOC, patologia de personalidade ou prejuízo.',
  ].join('\n'),
  ...
  EBPer: ['Definition: Indicador de unilateralidade do balanco experiencial.', 'Operational basis: So e calculado com EA>=4 e Lambda<1.0; exige |M-WSumC|>=2.0 quando EA e 4-10 ou >=2.5 quando EA>10, e depois divide o lado maior pelo menor.', 'Interpretive direction: Maior unilateralidade sugere dependencia mais rigida de um estilo.', 'Cross-checks: Integrar com Lambda, Afr e D/AdjD.', 'Caution: Fica indisponivel quando um dos lados de EB e zero.'].join('\n'),
  ...
  M_minus: ['Definition: Frequencia de movimento humano com baixa qualidade formal (M-).', 'Operational basis: Contagem de respostas que contem determinante M e FQ-.', 'Interpretive direction: Elevacao sugere maior distorcao na elaboracao ideacional.', 'Cross-checks: Revisar com XA%, WDA%, WSum6 e PTI.', 'Caution: E uma frequencia, nao uma proporcao.'].join('\n'),
  ...
  Mnone: ['Definition: Frequencia de movimento humano sem qualidade formal atribuivel.', 'Operational basis: Contagem de respostas com determinante M e FQ none; nao inclui FQu nem FQ-.', 'Interpretive direction: Elevacao sugere ancoragem formal menos estavel.', 'Cross-checks: Revisar com M-, WDA% e WSum6.', 'Caution: E uma frequencia, nao uma proporcao.'].join('\n'),
  FC_CF_C: ['Definition: Razao de modulacao de cor FC versus CF+C.', 'Operational basis: O rotulo convencional permanece, mas o lado direito exibido e CF+C+Cn. WSumC e o criterio 7 de S-CON mantem formulas separadas e excluem Cn.', 'Interpretive direction: FC dominante sugere maior modulacao; CF/C dominante menor controle.', 'Cross-checks: Integrar com Pure C, Afr e D/AdjD.', 'Caution: Interpretar com base total de respostas de cor.'].join('\n'),
  ...
  SumC_WSumC: ['Definition: Relacao de SumC\' com WSumC.', "Operational basis: Os dois valores brutos sao exibidos como SumC':WSumC; nao sao divididos nem reduzidos a um quociente.", 'Interpretive direction: Dominancia acromatica relativa sugere maior tom disforico.', 'Cross-checks: Integrar com SumV/SumY, DEPI e FC:CF+C.', 'Caution: Revisar sempre os dois componentes separadamente.'].join('\n'),
  Afr: ['Definition: Razao afetiva de aproximacao a estimulos cromaticos.', 'Operational basis: Respostas dos ultimos 3 cartoes divididas pelas respostas dos primeiros 7.', 'Interpretive direction: Afr baixo sugere constricao/evitacao; Afr alto maior aproximacao afetiva.', 'Cross-checks: Integrar com FC:CF+C, Pure C e EB/EBPer.', 'Caution: Sem respostas nos primeiros 7 cartoes, Afr nao e definido e aparece como indisponivel (-).'].join('\n'),
  ...
  Blends_R: ['Definition: Relacao entre respostas blend e R.', 'Operational basis: As duas contagens brutas sao exibidas como Blends:R; nao sao divididas nem reduzidas a um quociente.', 'Interpretive direction: Elevacao sugere maior complexidade de processamento.', 'Cross-checks: Integrar com DQ, WSum6 e mediacao.', 'Caution: Complexidade nao implica adaptacao automaticamente.'].join('\n'),
  ...
  _3r_2_R: ['Definition: Indice de egocentricidade (3r+(2)/R).', 'Operational basis: [3 x (Fr+rF) + Sum(2)] / R; cada reflexo recebe o peso de tres respostas de par.', 'Interpretive direction: Muito baixo sugere menor foco no self; muito alto maior foco no self.', 'Cross-checks: Integrar com Fr+rF, H ratio e interpessoal.', 'Caution: Evitar rotulos de traco por indice isolado.'].join('\n'),
...
const JA_DESCRIPTION_OVERRIDES: Partial<Record<string, string>> = {
  ...
  ZEst: ['Definition: プロトコル規模に基づく期待ZSumです。', 'Operational basis: Zfに応じてZEST表から参照します。', 'Interpretive direction: Zd解釈の基準線です。', 'Cross-checks: 観測ZSumとZdを同時に評価します。', 'Caution: Zf=1ではZEstは定義されず、算出不可(-)と表示されます。'].join('\n'),
  ...
  D: ['Definition: 現在のストレス耐性バランス指標です。', 'Operational basis: EA-esが-2.5以上+2.5以下なら0で、その後は追加2.5点ごとに同じ符号でDが1段階変化します。', 'Interpretive direction: 負値は需要が資源を上回る可能性を示唆します。', 'Cross-checks: AdjD, AdjEs, Core全体と統合します。', 'Caution: 状態依存性が高い指標です。'].join('\n'),
  AdjD: ['Definition: 調整後ストレス耐性指標です。', 'Operational basis: EA-AdjEsをDと同じ2.5点単位の尺度規則で変換します。', 'Interpretive direction: 一過性圧力の寄与分離に役立ちます。', 'Cross-checks: Dとの差分を必ず確認します。', 'Caution: 調整仮定の妥当性確認が必要です。'].join('\n'),
  PTI: [
    'Definition: PTIは知覚・思考の乱れに関するパターンをみる複合スクリーニング指標です。',
    'Operational basis: 形態質低下、重度認知特殊得点、M-などの複数基準で算出します。',
    '[Evidence Strength] supported. 特殊指標の中では経験的支持が比較的強いものの、思考障害や精神病性障害を単独で診断できません。',
    'Interpretive direction: 陽性基準が多いほど懸念は高まりますが、ラベルではなく実際の変数パターンを確認します。',
    'Cross-checks: XA%, WDA%, X-%, WSum6, M-、プロトコル品質と統合します。',
    'Caution: 構造化された注意信号として用い、臨床的統合判断を置き換えません。',
  ].join('\n'),
  DEPI: [
    'Definition: DEPIは抑うつ関連パターンのスクリーニングとして提案された操作的複合指標です。',
    'Operational basis: 情動収縮、苦痛、自己評価負荷などの複数基準で算出します。',
    '[Evidence Strength] limited. 抑うつ関連構成概念との経験的関連は限定的で、陽性のみから特定症状や診断を推論できません。',
    'Interpretive direction: 現在症状、持続期間、機能障害を追加評価し、陰性でも抑うつを除外しません。',
    'Cross-checks: SumV, MOR, Afr, FD、面接情報と統合します。',
    'Caution: 得点を抑うつエピソードの確定や除外に変換しません。',
  ].join('\n'),
  CDI: [
    'Definition: CDIは対処・対人脆弱性のスクリーニングとして提案された操作的複合指標です。',
    'Operational basis: 資源、相互性、調整負荷に関する基準を組み合わせます。',
    '[Evidence Strength] limited. 経験的関連は限定的で、無力感、未熟さ、依存性、固定特性を確定しません。',
    'Interpretive direction: 現在のストレス、実際の対処行動、支援、発達・文化的文脈を見直す暫定的な手掛かりとしてのみ用います。',
    'Cross-checks: EA, AdjD, COP/AG, SumT, Food、孤立指標と統合します。',
    'Caution: 推論を暫定的かつ文脈依存に保ちます。',
  ].join('\n'),
  SCON: [
    'Definition: S-CONは自殺関連リスク信号をみるスクリーニング構成です。',
    'Operational basis: 不快負荷、媒介の負荷、関連指標による多基準構成です。',
    '[Evidence Strength] supported-high-stakes. 自殺関連リスクとの関連は比較的強いものの、低い基礎率により偽陽性が生じ得て、陰性でもリスクを除外できません。',
    'Interpretive direction: 臨床的に懸念があれば得点にかかわらず直接リスク評価を行います。',
    'Cross-checks: 現在の希死念慮、意図、計画、手段へのアクセス、過去の試み、最近の変化、保護因子を直接確認します。',
    'Caution: 決定論的予測に用いず、必要な安全対応を優先します。',
  ].join('\n'),
  HVI: [
    'Definition: HVIは防衛的警戒や脅威監視を表すと提案された操作的変数の組合せです。',
    'Operational basis: 必須ゲート条件と追加基準数で算出します。',
    '[Evidence Strength] weak-inconsistent. 過警戒や不信を推論する経験的支持は弱く、一貫していません。',
    'Interpretive direction: 陽性は低信頼度の整理仮説としてのみ保持します。',
    'Cross-checks: 実際の危険、トラウマ歴、文化的な慎重さ、面接、独立して観察された警戒行動を確認します。',
    'Caution: 収束する根拠なしにパラノイア、不信、安定した特性を推論しません。',
  ].join('\n'),
  OBS: [
    'Definition: OBSは精密さと統制に関連する様式を表すと提案された操作的ルールの組合せです。',
    'Operational basis: 形態、組織化、統制に関するルールで判定します。',
    '[Evidence Strength] insufficient. 強迫的特性や機能障害を推論する構成概念妥当性の証拠は不十分です。',
    'Interpretive direction: 陽性は操作的な変数組合せが成立したという事実としてのみ扱います。',
    'Cross-checks: 完璧主義、強迫性、硬直性、苦痛、機能障害を面接と行動で独立に確認します。',
    'Caution: OBSを強迫的様式、OCD、人格病理、機能障害へ変換しません。',
  ].join('\n'),
  ...
  EBPer: ['Definition: EBの片側性指標です。', 'Operational basis: EA>=4かつLambda<1.0の場合のみ算出します。EAが4-10なら|M-WSumC|>=2.0、EA>10なら>=2.5を満たした後、大きい側を小さい側で除します。', 'Interpretive direction: 高値は単一スタイル依存の強さを示唆します。', 'Cross-checks: Lambda, Afr, D/AdjDと併読します。', 'Caution: EBの片側が0の場合は算出不可です。'].join('\n'),
  ...
  M_minus: ['Definition: 形態不良の人間運動(M-)頻度です。', 'Operational basis: M決定因とFQ-を同時に含む反応数を集計します。', 'Interpretive direction: 高値は観念形成の歪み増加を示唆します。', 'Cross-checks: XA%, WDA%, WSum6, PTIと統合します。', 'Caution: 比率ではなく頻度です。'].join('\n'),
  ...
  WDA_percent: ['Definition: 一般領域での適切形態質比率(WDA%)です。', 'Operational basis: W/D領域の適切反応を該当総数で除して算出します。', 'Interpretive direction: 低値は日常的媒介の不安定さを示唆します。', 'Cross-checks: XA%, X-%との乖離を確認します。', 'Caution: W/D反応がない場合は定義されず、算出不可(-)と表示されます。'].join('\n'),
  ...
  Mnone: ['Definition: 形態質を付与できない人間運動(Mnone)の頻度です。', 'Operational basis: M決定因とFQ noneを同時に含む反応のみを集計し、FQuとFQ-は含みません。', 'Interpretive direction: 高値は観念主体性の形態アンカー不安定を示唆します。', 'Cross-checks: M-、WDA%、WSum6と統合します。', 'Caution: 比率ではなく頻度です。'].join('\n'),
  FC_CF_C: ['Definition: 色彩調整比（FC対CF+C）です。', 'Operational basis: 慣例的名称は維持しますが、表示上の右側はCF+C+Cnで算出します。WSumCとS-CON基準7は別の式を用い、Cnを含めません。', 'Interpretive direction: FC優位は調整性増加、CF/C優位は調整低下を示唆します。', 'Cross-checks: Pure C、Afr、D/AdjDと統合します。', 'Caution: 色彩反応総数を考慮して解釈します。'].join('\n'),
  ...
  SumC_WSumC: ['Definition: SumC\'とWSumCの関係です。', "Operational basis: 2つの生値をSumC':WSumCとして並べて表示し、割り算や商への約分はしません。", 'Interpretive direction: 無彩色優位は不快トーンの相対的増加を示唆します。', 'Cross-checks: SumV/SumY、DEPI、FC:CF+Cと統合します。', 'Caution: 必ず構成要素ごとに確認します。'].join('\n'),
  Afr: ['Definition: 彩色情動刺激への接近を示す情動比です。', 'Operational basis: 後半3カード反応を前半7カード反応で除して算出します。', 'Interpretive direction: 低Afrは回避/収縮、高Afrは接近傾向を示唆します。', 'Cross-checks: FC:CF+C、Pure C、EB/EBPerと統合します。', 'Caution: 前半7カードに反応がない場合は定義されず、算出不可(-)と表示されます。'].join('\n'),
  ...
  Blends_R: ['Definition: Blends反応数とRの関係です。', 'Operational basis: 2つの生の頻度をBlends:Rとして並べて表示し、割り算や商への約分はしません。', 'Interpretive direction: 高値は多次元的処理複雑性の増加を示唆します。', 'Cross-checks: DQ、WSum6、媒介群と統合します。', 'Caution: 複雑性増加は自動的に適応性を意味しません。'].join('\n'),
  ...
  _3r_2_R: ['Definition: 自己中心性指数(3r+(2)/R)です。', 'Operational basis: [3 x (Fr+rF) + Sum(2)] / Rで、反射反応1個をpair反応3個分として重みづけします。', 'Interpretive direction: 極端低値は自己焦点低下、極端高値は自己焦点増加を示唆します。', 'Cross-checks: Fr+rF、H ratio、対人群と統合します。', 'Caution: 単独で特性ラベル化しません。'].join('\n'),
