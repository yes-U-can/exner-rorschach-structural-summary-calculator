...
const rawGasCodeData: Record<string, Record<string, Record<string, string>>> = {
    ...
    'Determinants': {
        ...
        'M': { ko: '인간운동의 구조요약 집계 라벨입니다. 개별 반응에는 Ma, Mp, Ma-p 중 하나를 입력합니다.', en: 'Structural Summary family label for human movement. Enter Ma, Mp, or Ma-p for an individual response.', ja: '人間運動の構造一覧表集計ラベルです。個々の反応にはMa、Mp、Ma-pのいずれかを入力します。', es: 'Etiqueta de familia del Sumario Estructural para movimiento humano. En una respuesta individual se ingresa Ma, Mp o Ma-p.', pt: 'Rótulo de família do Sumário Estrutural para movimento humano. Em uma resposta individual, insira Ma, Mp ou Ma-p.' },
        ...
        'FM': { ko: '동물운동의 구조요약 집계 라벨입니다. 개별 반응에는 FMa, FMp, FMa-p 중 하나를 입력합니다.', en: 'Structural Summary family label for animal movement. Enter FMa, FMp, or FMa-p for an individual response.', ja: '動物運動の構造一覧表集計ラベルです。個々の反応にはFMa、FMp、FMa-pのいずれかを入力します。', es: 'Etiqueta de familia del Sumario Estructural para movimiento animal. En una respuesta individual se ingresa FMa, FMp o FMa-p.', pt: 'Rótulo de família do Sumário Estrutural para movimento animal. Em uma resposta individual, insira FMa, FMp ou FMa-p.' },
        ...
        'm': { ko: '무생물운동의 구조요약 집계 라벨입니다. 개별 반응에는 ma, mp, ma-p 중 하나를 입력합니다.', en: 'Structural Summary family label for inanimate movement. Enter ma, mp, or ma-p for an individual response.', ja: '無生物運動の構造一覧表集計ラベルです。個々の反応にはma、mp、ma-pのいずれかを入力します。', es: 'Etiqueta de familia del Sumario Estructural para movimiento inanimado. En una respuesta individual se ingresa ma, mp o ma-p.', pt: 'Rótulo de família do Sumário Estrutural para movimento inanimado. Em uma resposta individual, insira ma, mp ou ma-p.' },
