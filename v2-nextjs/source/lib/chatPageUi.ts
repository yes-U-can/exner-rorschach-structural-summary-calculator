...
const CHAT_PAGE_UI: Record<Language, ChatPageUi> = {
  ...
  es: {
    copiedDescription:
      'La copia incluye los valores del Sumario Estructural para la revisión interpretativa.',
    ...
    welcomeTitle: 'Pega los valores del Sumario Estructural copiados desde la pantalla de resultados\ny empieza explicando el contexto que quieres que la IA considere.',
    welcomeCopiedTitle: 'Pega los valores del Sumario Estructural copiados desde la pantalla de resultados\ny empieza explicando el contexto que quieres que la IA considere.',
    summaryCsvLabel: 'Valores del Sumario Estructural',
  ...
  pt: {
    copiedDescription:
      'A cópia inclui os valores do Sumário Estrutural para revisão interpretativa.',
    ...
    welcomeTitle: 'Cole os valores do Sumário Estrutural copiados da tela de resultados\ne comece explicando o contexto que deseja que a IA considere.',
    welcomeCopiedTitle: 'Cole os valores do Sumário Estrutural copiados da tela de resultados\ne comece explicando o contexto que deseja que a IA considere.',
    summaryCsvLabel: 'Valores do Sumário Estrutural',
