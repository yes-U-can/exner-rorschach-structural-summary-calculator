...
displayTitle: "[Interpretation] result-interpretation"
aliases:
...
status: "draft"
runtimeReady: false
provenanceNote: "docs/reference-authoring/notes/provenance/en/result-interpretation/index.md"
---
...
- This domain must stay separate from `scoring-input` documents.
- A high or low score does not automatically equal a diagnosis.
