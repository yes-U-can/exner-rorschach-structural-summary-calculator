...
`FT` は、形が反応を主に組織化し、質感や触覚的性質が二次的に加わるときにつける決定因です。
ざらざら、柔らかい、布のようだといった感触があるが、まず形で対象が分かる反応です。

## 採点・適用条件

- 形が主な対象同定を支えています。
- そのうえで触覚・表面・質感の性質が述べられています。
- 質感手がかりは反応または質問段階の中で実際に語られている必要があります。
- 質感の方が重いなら [`TF`](ref://scoring-input/determinants/TF) を再検討します。
