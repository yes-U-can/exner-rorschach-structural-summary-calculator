...
`Bt` は、主内容が植物界に属するときに付ける内容コードです。  
植物、花、木、葉、枝など、植物として理解される対象を扱います。
...
- 文献によっては `BT` と書かれることがありますが、この corpus では canonical code を `Bt` に固定します。
