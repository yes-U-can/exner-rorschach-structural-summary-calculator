...
- Si la forma termina organizando la respuesta, debe reconsiderarse [`FY`](ref://scoring-input/determinants/FY).
- Si casi no hay apoyo formal, puede corresponder [`Y`](ref://scoring-input/determinants/Y).
