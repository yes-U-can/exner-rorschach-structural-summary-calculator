...
- `Fi` y [`Ex`](ref://scoring-input/contents/Ex) no se distinguen por intensidad visual sino por contenido nombrado.
- `Fi` y [`Cl`](ref://scoring-input/contents/Cl) pueden parecer parecidos si la forma es difusa, pero uno es humo/fuego y el otro nube.
- No se debe usar `Fi` solo por color rojo u oscuro; el sujeto tiene que decir fuego o humo.
