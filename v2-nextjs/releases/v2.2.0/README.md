...
> **2026-07-16 정정:** v2.2.0의 UI/UX 변경 기록은 그대로 유효하지만 계산 감사의 일부 판정은 불완전했습니다. D/AdjD 상한, EBPer gate, GHR/PHR 순서, Cn 표시, 정의 불가 분모 처리는 [v2.2.1 계산 정확성 핫픽스](../v2.2.1/)에서 교정했습니다. 또한 계산기는 연령을 입력받지 않으며, 연령 제한이 있는 해석을 요청한 경우에만 AI 해석 대화에서 확인합니다. 이 문서는 당시 기록을 보존하고, 계산 관련 최종 판정은 v2.2.1 문서를 기준으로 합니다.
