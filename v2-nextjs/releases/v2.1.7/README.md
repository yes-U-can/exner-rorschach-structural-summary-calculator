...
v2.1.7은 공개 전시용 아카이브의 README, CHANGELOG, 릴리즈 노트, 버전 아카이브, AI eval 증거 문서가 따라야 할 운영 원칙과 언어 범위 정책을 명문화한 거버넌스 패치입니다.
...
최초 요약의 “v2.1.x AI 품질 작업 마감”은 범위가 지나치게 넓었습니다. 최종 릴리즈 흐름에서 v2.1.7이 완료한 것은 **공개 릴리즈 문서 거버넌스 범위**입니다. 이후 v2.1.8-v2.1.10에서 진행한 코퍼스·벡터·검색 기술 작업은 이 문서 거버넌스 성과와 별개의 후속 범위입니다.
