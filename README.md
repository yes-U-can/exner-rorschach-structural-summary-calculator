...
패치노트의 첫부분에는 계산 결과가 어떻게 달라졌는지, 어떤 프로토콜이 영향을 받을 수 있는지, 기존 결과를 다시 계산해야 하는지를 적었습니다. 확인에 사용한 근거와 개발 세부 사항은 그 뒤에 두었습니다.
...
- 공개 문서의 작성 기준은 [공개 릴리즈 문서 원칙](./v2-nextjs/source/docs/ops/PUBLIC_RELEASE_DOCUMENTATION.md)에서 확인할 수 있습니다.
