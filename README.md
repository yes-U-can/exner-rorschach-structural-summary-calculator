...
구조요약 입력값, 계산 결과, AI 대화 내용과 API 키는 방문 통계에 포함되지 않습니다. 계산식, 채점 기준과 산출값은 바뀌지 않았으므로 기존 프로토콜을 다시 계산할 필요가 없습니다. 자세한 내용은 [v2.2.12 패치노트](./v2-nextjs/releases/v2.2.12/)에서 확인할 수 있습니다.
