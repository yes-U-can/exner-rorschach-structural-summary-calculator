...
9. Lead with the clinical effect in ordinary professional language. Keep implementation details, test counts, build output, commands, and file-level evidence outside reader-facing release notes.
