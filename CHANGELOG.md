...
> **릴리즈 날짜 표기 정리 (2026-07-18):** 새벽 작업이 자정을 오간 일부 버전은 커밋 시각이 아니라 당시 운영상 선언한 Asia/Seoul 날짜를 기준으로 아카이브 표기를 통일했습니다. 변경 전후 날짜와 이유는 [v2.2.3 패치노트](./v2-nextjs/releases/v2.2.3/#공개-문서와-릴리즈-날짜)에 기록했으며, 소스 이력과 검사 보고서 작성일은 바꾸지 않았습니다.
