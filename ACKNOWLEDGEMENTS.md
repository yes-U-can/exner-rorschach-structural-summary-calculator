...
v2의 구현과 반복 검사는 OpenAI Codex를 사용했습니다. 공개 전 독립 검토에는 Claude Fable 5와 Claude Opus 4.8을 사용했으며, v2.2.10의 독립 검토에는 Claude Opus 5를 사용했습니다.

v2.2.13의 개발·검증에는 OpenAI Codex의 GPT-6 Astra, 독립 검토에는 Claude Code의 Claude Fable 5.1을 사용했습니다. 이는 제품 개발에 사용한 도구이며, 웹앱에서 제공하는 AI 도우미의 모델을 변경한 것은 아닙니다.
